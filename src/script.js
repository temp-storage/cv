 function cardS()
 {
    ...
    document.body.style.backgroundImage = "url(src/img/bg_gif2.gif)"
...
function card0f(num)
{
    ...
    switch(num) 
    {
        case 1:
            ...
            document.body.style.backgroundImage = "url(src/img/bg_gif3.gif)";
            const T = new Date();
        ...
        case 2:
            ...
            document.body.style.backgroundImage = "url(src/img/bg_gif4.gif)";
            document.getElementById("card0").innerHTML = 
        ...
        case 3:
            ...
            document.body.style.backgroundImage = "url(src/img/bg_gif5.gif)";
            document.getElementById("card0").innerHTML = 
